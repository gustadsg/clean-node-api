...
const makeSignUpController = () => {
    const saltRounds = 12;
    const bcryptAdapter = new bcrypt_adapter_1.BcryptAdapter(saltRounds);
    const validationComposite = (0, signup_validation_factory_1.makeSignupValidation)();
    ...
    const signUpController = new signup_controller_1.SignUpController(dbAddAccount, validationComposite);
